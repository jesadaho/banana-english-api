...
- When Core Flow reaches Summary + Celebrate, set isLessonComplete = true (required). Otherwise false. Never end without completing.`,
  ...
  },
  {
    ...
    titleTh: 'ตัวเลข 11–20',
    goalEn: 'Recognize, read, and say numbers 11–20 confidently.',
    goalTh: 'ฟัง อ่าน และพูดตัวเลข 11–20 ได้อย่างมั่นใจ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 4,
    ...
    progressMax: 5,
    systemInstruction:
      'Lesson: Numbers 11–20. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Numbers 11–20 for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_say_it_again',
    targetLabel: 'phrase',
    titleEn: 'Say It Again',
    titleTh: 'พูดอีกครั้ง',
    goalEn:
      'Ask someone to repeat and ask how to say something in English.',
    goalTh:
      'ขอให้พูดอีกครั้ง และถามว่าพูดว่าอะไรเป็นภาษาอังกฤษ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 4,
    ...
    progressMax: 5,
    systemInstruction:
      'Lesson: Say It Again. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Say It Again for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_how_do_you_feel',
    targetLabel: 'phrase',
    titleEn: 'How Do You Feel?',
    titleTh: 'คุณรู้สึกอย่างไร?',
    goalEn: 'Ask and say basic feelings with How do you feel? / I\'m...',
    goalTh: 'ถามและบอกความรู้สึกพื้นฐานด้วย How do you feel? / I\'m...',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    ...
    progressMax: 6,
    systemInstruction:
      'Lesson: How Do You Feel?. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start How Do You Feel? for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_basic_colors',
    targetLabel: 'color',
    titleEn: 'Basic Colors',
    titleTh: 'สีพื้นฐาน',
    goalEn: 'Name five basic colors and say which color you like.',
    goalTh: 'เรียกชื่อสีพื้นฐาน 5 สี และบอกสีที่ชอบ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 5,
    targetPhrases: ['red', 'blue', 'yellow', 'green', 'black', 'I like blue.'],
    maxTurns: 18,
    progressMax: 6,
    systemInstruction:
      'Lesson: Basic Colors. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Basic Colors for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_shop_things',
    targetLabel: 'shop item',
    titleEn: 'Things at the Shop',
    titleTh: 'ของในร้าน',
    goalEn: 'Name five things at a shop and say what you want.',
    goalTh: 'เรียกชื่อของในร้าน 5 อย่าง และบอกสิ่งที่อยากได้',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 5,
    targetPhrases: ['bag', 'shirt', 'book', 'shoes', 'hat', 'I want a bag.'],
    maxTurns: 18,
    progressMax: 6,
    systemInstruction:
      'Lesson: Things at the Shop. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Things at the Shop for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_daily_actions',
    targetLabel: 'action',
    titleEn: 'Daily Actions',
    titleTh: 'กิจวัตรประจำวัน',
    goalEn: 'Say five common daily actions in simple sentences.',
    goalTh: 'พูดกิจวัตรประจำวัน 5 อย่างด้วยประโยคง่ายๆ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 5,
    targetPhrases: ['I wake up.', 'I eat.', 'I study.', 'I work.', 'I sleep.'],
    maxTurns: 18,
    progressMax: 6,
    systemInstruction:
      'Lesson: Daily Actions. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Daily Actions for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_places_directions',
    targetLabel: 'place or direction',
    titleEn: 'Places & Simple Directions',
    titleTh: 'สถานที่และการบอกทาง',
    goalEn: 'Name useful places and transport, then ask for and give a simple direction.',
    goalTh: 'เรียกชื่อสถานที่และการเดินทาง พร้อมถามและบอกทางง่ายๆ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 5,
    ...
    progressMax: 6,
    systemInstruction:
      'Lesson: Places & Simple Directions. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Places & Simple Directions for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_goodbye_closing',
    targetLabel: 'closing phrase',
    titleEn: 'Goodbye & Closing',
    titleTh: 'กล่าวลาและจบสนทนา',
    goalEn: 'Close a conversation with several friendly goodbye phrases.',
    goalTh: 'จบบทสนทนาด้วยคำกล่าวลาที่เป็นมิตรหลายแบบ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 4,
    ...
    progressMax: 5,
    systemInstruction:
      'Lesson: Goodbye & Closing. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Goodbye & Closing for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    ...
    titleEn: 'We / They',
    titleTh: 'เรา / พวกเขา',
    goalEn: 'Use We\'re... for your group and They\'re... for other people.',
    goalTh: 'ใช้ We\'re... กับกลุ่มของเรา และ They\'re... กับคนกลุ่มอื่น',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 5,
    ...
    progressMax: 6,
    systemInstruction:
      'Lesson: We / They. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start We / They for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
    lessonId: 'fnd_v2_buying_something',
    targetLabel: 'phrase',
    titleEn: 'Buying Something',
    titleTh: 'ซื้อของ',
    goalEn: 'Say what you want and close a simple purchase in English.',
    goalTh: 'บอกสิ่งที่ต้องการและปิดการซื้อง่ายๆ เป็นภาษาอังกฤษ',
    difficulty: 'beginner',
    languageMix: { thai: 70, english: 30 },
    estimatedMinutesMin: 3,
    estimatedMinutesMax: 5,
    ...
    progressMax: 6,
    systemInstruction:
      'Lesson: Buying Something. Scripted PoolGate / Training V2 foundation lesson. Follow the forced boards; do not invent alternate curriculum.',
    openingPrompt:
      'Start Buying Something for this learner. Use Training V2 / PoolGate opening from the foundation registry.',
  },
  {
...
- When Core Flow reaches Node 10, set isLessonComplete = true (required). Otherwise false.`,
  ...
  buildPronunciationLesson({
    ...
    goalEn: 'Say the final S clearly on plural words.',
    goalTh: 'ออกเสียง S ท้ายคำนามพหูพจน์ให้ชัด',
    soundLabel: 'a clear final /s/ or /z/ on plural words',
    items: ['books', 'bags', 'pens', 'apples'],
    ...
    chapterOverviewTh:
      'เสียง S ตอนท้ายช่วยให้ผู้ฟังรู้ว่ามีของมากกว่าหนึ่งชิ้น',
    chapterOverviewEn:
      'A clear final S helps the listener hear that there is more than one thing.',
    contrasts: [{ wrong: 'บุ๊ค', right: 'books' }],
    explainTh: 'คำนามพหูพจน์ต้องมีเสียง S ท้ายคำ ไม่อย่างนั้นอาจฟังเหมือนมีชิ้นเดียว',
    explainEn: 'Plural nouns need the final S, or they may sound singular.',
  }),
  buildPronunciationLesson({
