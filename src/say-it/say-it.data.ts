...
export const SAY_IT_TOPICS: SayItTopic[] = [
  ...
  {
    id: 'mind_feelings',
    titleEn: 'Mind & Feelings',
    titleTh: 'Mind & Feelings',
    subtitleEn: 'Thoughts and feelings',
    subtitleTh: 'ความคิดและความรู้สึก',
    emoji: '🧠',
  ...
  },
  {
    ...
    titleTh: 'Everyday Phrases',
    subtitleEn: 'Daily life sentences',
    subtitleTh: 'ประโยคใช้ในชีวิตประจำวัน',
    emoji: '☕',
  ...
  },
  {
    ...
    titleTh: 'Travel & Transportation',
    subtitleEn: 'Travel and transport',
    subtitleTh: 'การเดินทางและการขนส่ง',
    emoji: '✈️',
    accentColor: 0xff42a5f5,
    estimatedMinutes: 3,
    poolSize: 20,
