...
export const SAY_IT_TOPICS: SayItTopic[] = [
  ...
  },
  {
    ...
    titleEn: 'What',
    titleTh: 'What',
    subtitleEn: 'Ask about things and actions',
    subtitleTh: 'ถามเรื่องสิ่งของและสิ่งที่เกิดขึ้น',
    emoji: '❓',
  ...
  },
  {
    ...
    titleEn: 'When',
    titleTh: 'When',
    subtitleEn: 'Ask about time and plans',
    subtitleTh: 'ถามเรื่องเวลาและแผน',
    emoji: '🗓️',
  ...
  },
  {
    ...
    titleEn: 'Why',
    titleTh: 'Why',
    subtitleEn: 'Ask for reasons',
    subtitleTh: 'ถามหาเหตุผล',
    emoji: '💡',
