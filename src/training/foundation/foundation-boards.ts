...
> = {
  ...
  numbers: {
    1: {
      ...
      ttsText:
        'สวัสดีครับ {name}! วันนี้เราจะฝึกคำอ่านภาษาอังกฤษของตัวเลขศูนย์ถึงยี่สิบกันครับ 🔢 เลขศูนย์อ่านว่า ซีโร ส่วนเลขหนึ่งถึงห้าอ่านว่า “one, two, three, four, five” มีแอปเปิลกี่ลูกครับ? 🍎🍎🍎🍎',
      withPraise: false,
      stem: '',
      expectedSpeech: 'four',
