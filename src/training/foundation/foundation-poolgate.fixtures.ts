...
export const FOUNDATION_POOLGATE_FIXTURES: FoundationPoolGateFixture[] = [
  ...
  },
  {
    ...
    setupExact: ['red'],
    exactAtProbe: 'blue',
    outOfPoolAtProbe: 'the color blue',
    wrongAtProbe: 'Good morning.',
    wrongAgainAtProbe: 'Hello.',
  },
  {
    lessonId: 'fnd_v2_shop_things',
    setupExact: ['bag', 'shirt'],
    exactAtProbe: 'shirt',
    outOfPoolAtProbe: 'this is a shirt',
    wrongAtProbe: 'Good morning.',
    wrongAgainAtProbe: 'Hello.',
  },
  {
  ...
  },
  {
    ...
    setupExact: ['I wake up.', 'I eat.'],
    exactAtProbe: 'I study.',
    outOfPoolAtProbe: 'I am studying.',
    wrongAtProbe: 'Good morning.',
    wrongAgainAtProbe: 'Hello.',
  },
  {
  ...
  },
  {
    ...
    setupExact: ['bathroom', 'Where is the bathroom?'],
    exactAtProbe: 'Where is the hotel?',
    outOfPoolAtProbe: 'Can you tell me where the hotel is?',
    wrongAtProbe: 'Good morning.',
    wrongAgainAtProbe: 'Hello.',
  },
  {
    lessonId: 'fnd_v2_goodbye_closing',
    setupExact: ['Goodbye.', 'See you later.'],
    exactAtProbe: 'See you later.',
    outOfPoolAtProbe: 'I will see you later',
    wrongAtProbe: 'Good morning.',
    wrongAgainAtProbe: 'Hello.',
  },
];
